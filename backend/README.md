...
## Project Structure
    ...
    ├── testapiautosetting_127043  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127043`
...
2. Clone this repo and `cd testapiautosetting_127043`
